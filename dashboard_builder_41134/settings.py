"""
Django settings for dashboard_builder_41134 project.
...
ROOT_URLCONF = 'dashboard_builder_41134.urls'
...
WSGI_APPLICATION = 'dashboard_builder_41134.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dashboard_builder_41134 API",
    "DESCRIPTION": "API documentation for dashboard_builder_41134 App",
    "VERSION": "v1",
}
